...
(define-key mu4e-view-mode-map    (kbd "r") 'my-mu4e-archive-thread-from-view)
(define-key mu4e-headers-mode-map (kbd "m") 'my-mu4e-mute-thread)
(define-key mu4e-view-mode-map    (kbd "m") 'my-mu4e-mute-thread-from-view)
(define-key mu4e-headers-mode-map (kbd "t") 'my-mu4e-msg-to-task)
(define-key mu4e-headers-mode-map (kbd "t") 'my-mu4e-msg-to-task-from-view)
